        ...
        <div class="footer__container">
            ...
            <div class="footer__body">
                <div class="footer__social">
                    <div>
                        <!-- TikTok -->
                        <a href="{{ config('contact.social.tiktok') }}" class="link" target="_blank">
                    ...
                    <div>
                        <!-- Twitter -->
                        <a href="{{ config('contact.social.twitter') }}" class="link" target="_blank">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div>
                        <!-- Discord -->
                        <a href="{{ config('contact.social.discord') }}" class="link" target="_blank">
                            <svg fill="white" width="25" height="25" viewBox="0 -28.5 256 256" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                <g>
